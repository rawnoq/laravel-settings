...
You can include settings from one group into another using `_include`:
...
return [
    'translatable' => [
        ...
        'seo' => [
            '_include' => ['base'], // Include all settings from 'base' group
            'meta_description' => [
                'en' => 'Site Description',
                'ar' => 'وصف الموقع',
            ],
...
// With translations
$setting = Setting::with('translations')->where('key', $key)->firstOrFail();
```
